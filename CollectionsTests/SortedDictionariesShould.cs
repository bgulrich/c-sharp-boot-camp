...
{
    public class SortedDictionariesShould
    {
        #region Basics
        [Fact]
        ...
        {
            var livestockCounts = new SortedDictionary<string, int>
            {
                {"chickens", 500},
                {"cows", 50 }
            };
            ...
            var caseInsensitiveLivestockCounts = new SortedDictionary<string, int>(StringComparer.InvariantCultureIgnoreCase)
            {
                {"chickens", 500},
                {"cows", 50 }
            };
        ...
        public void AllowComparerOverriding_Custom()
        {
            ...
            var caseInsensitiveLivestockCounts = new SortedDictionary<string, int>(new CaselessStringComparer())
            {
                {"chickens", 500},
                {"cows", 50 }
            };
